...
public class TeacherMenu {
    ...
    public static void viewClass(String fullClass) throws SQLException {
        ...
        Core.printQuery("SELECT * FROM students s WHERE s.class_year = '" + classYear + "' AND s.class_letter = '" + classLetter + "';");
    }
    ...
    public static void grade(String date, double grade, String subjectName, String studentID, String teacherEmail) throws SQLException {
        String teacherID = Core.searchLoginID(teacherEmail), subjectID = Core.searchSubjectID(subjectName);
        Core.doUpdate("INSERT INTO grades (`date`,`grade`,`subject_id`,`student_id`,`teacher_id`) VALUES ('" + date + "', '" + grade + "', '" + subjectID + "', '" + studentID + "', '" + teacherID + "');");
    }
    ...
    public static void takeAttendance(String date) throws SQLException {
        ...
        ResultSet countRs = Core.doQuery(countQuery);
        int count = 0;
        if (countRs.next()) {
        ...
        if(count > 0){
            ...
            ResultSet rs = Core.doQuery(studentQuery);
    ...
    public static void sendFeedback(String date, String comment, String teacherEmail, String studentID) throws SQLException {
        Core.doUpdate("INSERT INTO comments (`date`,`feedback`,`student_id`,`teacher_id`) VALUES ('" + date + "','" + comment + "','" + studentID + "','" + Core.searchLoginID(teacherEmail) + "');");
    }
